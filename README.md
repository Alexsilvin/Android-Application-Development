...
```
Android-Application-Development/
├── exercises/          # Practice exercises and coding drills
├── assignments/        # Course assignments
├── projects/           # Larger exam and capstone projects
└── README.md          # This file
```
...
### Assignments
Structured assignments that build upon learned concepts:
...
### Projects
Comprehensive exam and capstone projects demonstrating:
- Complete application architecture
- Integration of multiple Android components
...
```bash
git clone https://github.com/Alexsilvin/Android-Application-Development.git
cd Android-Application-Development
```
...
Each exercise, assignment, or project can be run individually:
...
- **Semester/Year**: [Add semester/year if applicable]

---

**Last Updated**: March 2026

**Repository URL**: [https://github.com/Alexsilvin/Android-Application-Development](https://github.com/Alexsilvin/Android-Application-Development)
